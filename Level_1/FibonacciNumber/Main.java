 ...
 * include using an Array, or better still using 3 volatile variables to keep a track of 
 * all required values. Check out this blog post to examine better solutions for this problem.
 * 
 * Examples:
 * 
 * fib(0) ==> 0
